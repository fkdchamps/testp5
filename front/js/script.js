...
function displayShop(ArrayProduitsJson) {/* récupération et affichage des produits */ //deuxième enchainement de fonction pour extraire les données propres à chaque produit
    ...
    for (let product of ArrayProduitsJson) {
      ...
      function createArticle(i) {
        ...
        newAnchor.id = "anchor" + i/* articleIndex */;//on affecte un id# unique à cette balise
        ...
        function displayArticle() {
          ...
          newArticle.id = "article" + i/* articleIndex */;
